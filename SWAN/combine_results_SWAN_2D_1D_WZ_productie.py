...
"""
--- Synopsis --- 
This scripts combines the results of SWAN2D and SWAN1D runs for the Waddenzee.

--- Remarks --- 
See also: 
To-Do: 
Dependencies: 
    Script to write SWAN1D output to Excel: read_SWAN_1D_model_WZ_iteratie_productie.py
    Script to write SWAN2D output to Excel: SWAN_2D_output_to_xlsx_WZ_productie.py

--- Version --- 
Created on Mon Oct  3 16:43:04 2022
@author: ENGT2
Project: KP ZSS (130991)
Script name: combine_results_SWAN_2D_1D_WZ_productie.py 
