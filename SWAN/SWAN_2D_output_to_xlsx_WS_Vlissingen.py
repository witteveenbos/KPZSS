...
path_main   = r'z:\130991_Systeemanalyse_ZSS\3.Models\SWAN\2D\Westerschelde\tests\batch_03_Vlissingen'
...
fname = os.path.join(path_main,"output_batch_03_Vlissingen_%s_%s.xlsx" % (OKid,outloc))
